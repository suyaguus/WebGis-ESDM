...
function AdminPerusahaanApp() {
  ...
  const page = (() => {
    switch (activePage) {
      ...
      case "ap-sumur":
        return <AdminSumurPage />;
      case "ap-dokumen":
        return <AdminDokumenPage />;
      case "ap-status":
...
function SurveyorApp() {
  ...
  const page = (() => {
    switch (activePage) {
      ...
      case "sv-sumur":
        return <SurveyorSensorPage />;
      case "sv-input":
        return <SurveyorInputPage />;
      case "sv-dokumen":
        return <SurveyorDokumenPage />;
      case "sv-peta":
        return <SurveyorPetaPage />;
      case "sv-laporan":
        return <SurveyorLaporanPage />;
      case "sv-kirim":
        return <SurveyorKirimPage />;
      default:
        return <SurveyorDashboard />;
    }
  })();
...
export default function App() {
  ...
  const handlePublicNavigate = useCallback(
    (page: "landing" | "home" | "info" | "contact") => {
      const routeMap = {
