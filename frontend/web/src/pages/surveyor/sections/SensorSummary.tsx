        ...
        {SURVEYOR_SENSORS.map(sensor => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-0.5">
                ...
                <span className={cn(
                  ...
                  sensor.type === 'gnss' ? 'text-amber-600 bg-amber-50' : 'text-blue-600 bg-blue-50',
                )}>
            ...
            <div className="text-right flex-shrink-0">
              <p className={cn('text-[11px] font-mono font-semibold', getSubsidenceColor(sensor.subsidence))}>
                {sensor.subsidence.toFixed(2)} cm/thn
              </p>
              {sensor.waterLevel && (
                <p className="text-[9px] font-mono text-slate-400">MAT: {sensor.waterLevel} m</p>
              )}
              <p className="text-[8px] font-mono text-slate-400">{sensor.lastUpdate}</p>
            </div>
          </div>
        ))}
      </div>
