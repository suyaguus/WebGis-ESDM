        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-slate-600 mb-6">
              Platform monitoring terpadu untuk data sensor air tanah di
              Provinsi Lampung. Akses informasi real-time tentang kondisi dan
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 border border-slate-200 rounded-xl hover:shadow-lg transition">
              ...
              <p className="text-slate-600">
                Pantau status sensor air tanah secara langsung dengan data
                terkini dan akurat.
              </p>
            </div>
            ...
            <div className="p-6 border border-slate-200 rounded-xl hover:shadow-lg transition">
              ...
              <p className="text-slate-600">
                Akses data historis dan analitik tren untuk pengambilan
            ...
            <div className="p-6 border border-slate-200 rounded-xl hover:shadow-lg transition">
              ...
              <p className="text-slate-600">
                Buat dan unduh laporan detail tentang kondisi muka air tanah dan
                ketersediaan sumber daya air.
              </p>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-16 md:py-24">
        <div className="bg-gradient-to-r from-cyan-500 to-blue-500 rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <p className="text-lg mb-8 opacity-90">
            Daftar sekarang untuk mengakses dashboard analitik lengkap dan data
            sensor real-time.
          </p>
          <button
            onClick={onRegister}
