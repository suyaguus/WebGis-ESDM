...
const ACTION_ICONS: Record<string, ReactNode> = {
  ...
  APPROVE_PERMIT: <FontAwesomeIcon icon={faCheckCircle} />,
    ...
    <div className="p-3 sm:p-5 space-y-4">
      ...
      <Card padding={false}>
        ...
        <div className="px-4 py-3 border-t border-slate-100 bg-slate-50/50 flex items-center justify-between">
          ...
          <button className="text-[10px] text-cyan-600 hover:text-cyan-800 font-mono font-medium">
            Muat lebih banyak →
          </button>
        </div>
      </Card>
