...
const ROLES = [
  {
    ...
    count: 1,
    desc: "Verifikasi data dari semua pihak, kelola sistem, & kirim laporan ke Kadis",
  },
  {
    key: "admin_perusahaan",
    label: "Admin Perusahaan",
    color: "bg-amber-50 text-amber-700 border-amber-200",
    count: 4,
    desc: "Input data sumur perusahaan & ajukan dokumen legalitas sumur",
  },
  {
    key: "surveyor",
    label: "Surveyor",
    ...
    count: 6,
    desc: "Petakan sensor air tanah berdasarkan data sumur perusahaan",
  },
  {
    key: "kadis",
    label: "Kepala Dinas",
    ...
    count: 2,
    desc: "Terima & review laporan terverifikasi dari Super Admin, setujui izin",
  },
];
...
const PERMISSION_GROUPS = [
  {
    ...
    items: [
      ...
      {
        label: "Peta Semua Sensor (Provinsi)",
        perms: [true, false, false, true],
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Verifikasi Dokumen Legalitas",
        perms: [false, false, true, false],
      },
      {
        label: "Kirim Laporan ke Super Admin",
        perms: [false, false, true, false],
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      {
        label: "Terima Laporan Terverifikasi",
        perms: [true, false, false, true],
      },
      { label: "Review & Analitik Tren", perms: [true, false, false, true] },
      {
        label: "Setujui / Tolak Izin Sumur",
        perms: [false, false, false, true],
      },
    ...
    <div className="p-3 sm:p-5 space-y-4">
      <div>
        ...
        <p className="text-[11px] text-slate-400 font-mono mt-0.5">
          Konfigurasi hak akses per role pengguna
        </p>
      </div>
        ...
        {ROLES.map((r) => (
          <button
            ...
            className={cn(
              ...
              selected === r.key
                ? "border-cyan-300 ring-1 ring-cyan-200 shadow-md"
        ...
        <div className="overflow-x-auto">
          <div className="inline-block min-w-full">
            ...
            <div className="flex border-b border-slate-100 bg-slate-50/60">
              <div
                className="text-[9px] font-mono text-slate-400 uppercase tracking-wider px-4 py-3 text-left font-semibold"
            ...
            {PERMISSION_GROUPS.map((group) => (
              <div key={group.group}>
                ...
                <div className="flex bg-slate-50/40 border-b border-slate-50">
                  <div
                    className="px-4 py-2 text-[9px] font-mono font-semibold text-slate-500 uppercase tracking-widest"
                    style={{ width: "200px", flexShrink: 0 }}
                  >
                    {group.group}
                  </div>
                ...
                {group.items.map((item) => (
                  <div
                    key={item.label}
                    className="flex border-b border-slate-50 hover:bg-slate-50/40 transition-colors"
                  >
                    <div
                      className="px-4 py-3 text-[11px] text-slate-600"
                      style={{ width: "200px", flexShrink: 0 }}
                    >
                      {item.label}
                    </div>
                    {item.perms.map((allowed, i) => (
                      <div
                        ...
                        className={cn(
                          ...
                          selected === ROLES[i].key
                            ? "ring-1 ring-inset ring-cyan-200"
                            : "",
                        )}
                        style={{ width: "80px", flexShrink: 0 }}
                      >
      ...
      <div className="flex items-start gap-3 bg-blue-50 border border-blue-200 rounded-xl px-4 py-3">
        ...
        <div>
          ...
          <p className="text-[10px] text-blue-600 leading-relaxed">
            Perubahan hak akses hanya dapat dilakukan oleh Super Admin dan
            berlaku langsung setelah disimpan. Setiap modifikasi role akan
            tercatat di Audit Log untuk keperluan kepatuhan regulasi.
          </p>
        </div>
      </div>
    </div>
