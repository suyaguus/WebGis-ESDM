...
export default function AdminPetaPage() {
  ...
  return (
    <div className="flex flex-col h-full min-w-0 overflow-hidden" style={{ minHeight: 0 }}>
      ...
      <div className="md:hidden flex-shrink-0 max-h-[28vh] overflow-y-auto bg-white border-b border-slate-100 divide-y divide-slate-50">
        {filtered.map(s => (
          <button key={s.id} onClick={() => setSelected(s)}
            className={cn('w-full text-left px-4 py-2 flex items-center gap-3 transition-colors',
      ...
      <div className="md:hidden flex-1 relative overflow-hidden" style={{ minHeight: '200px' }}>
        {selected && (
