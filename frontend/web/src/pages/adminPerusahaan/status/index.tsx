...
const INITIAL_ITEMS: SubmissionItem[] = COMPANY_MEASUREMENTS.map(
  (measurement) => {
    ...
    <div className="p-3 md:p-5 space-y-3 md:space-y-4">
      <div>
        ...
        <p className="text-[11px] text-slate-400 font-mono mt-0.5">
          Pantau progres pengajuan data dan dokumen lapangan
        </p>
      </div>
        ...
        {selected ? (
            ...
            <div className="p-4 space-y-3.5">
              ...
              <div className="rounded-lg border border-slate-100 bg-white px-3 py-2.5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between text-[10px]">
                    <span className="text-slate-500">
                      Sinkronisasi ke super admin
                    </span>
                    <span className="font-mono text-slate-700">
                      {selected.status === "verified" ? "Siap kirim" : "-"}
                    </span>
                  </div>
                </div>
              </div>
          ...
          >
            <p className="text-[11px] text-slate-400 font-mono text-center">
              Pilih data untuk melihat detail status
            </p>
          </div>
        )}
      </div>
