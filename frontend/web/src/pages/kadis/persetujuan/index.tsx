...
const PERMIT_REQUESTS: PermitRequest[] = [
  {
    ...
    priority: "urgent",
    notes:
      "Permintaan tambahan kuota karena peningkatan produksi 15% di wilayah Metro.",
    recommendation:
      "Perlu evaluasi status muka air tanah pada 2 sumur pantau aktif.",
  },
  {
    id: "pr2",
    code: "IZN-2026-015",
    ...
    priority: "normal",
    notes:
      "Penyesuaian kuota untuk kebutuhan operasional tambahan area Rajabasa.",
  ...
  },
  {
    ...
    status: "approved",
    priority: "normal",
    notes: "Pengajuan kuota regular tahunan dengan tren muka air tanah stabil.",
...
export default function KadisPersetujuanPage() {
  ...
  const Th = ({ label, k }: { label: string; k: SortKey }) => (
    ...
    >
      <span className="flex items-center gap-1">
        ...
        <ArrowUpDown
          size={9}
          className={sortKey === k ? "text-emerald-500" : "text-slate-300"}
        />
      </span>
    </th>
  );
  ...
  return (
    <div className="p-3 sm:p-5 space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[11px] text-slate-400 font-mono mt-0.5">
            Validasi dan keputusan izin pengambilan air tanah
          </p>
        </div>
        {summary.pending > 0 && (
                    ...
                    >
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[11px] font-semibold font-mono text-slate-800">
                            {row.code}
                          </span>
                        </div>
                      </td>
          ...
          <Card padding={false}>
            ...
            <div className="p-4 space-y-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <p className="text-[12px] font-semibold font-mono text-slate-800">
                    {(selected.requestedQuota / 1000).toFixed(0)}k m3
                  </p>
                </div>
                <div>
                  <p className="text-[9px] font-mono text-slate-400">
                  ...
                  <p className="text-[12px] font-semibold font-mono text-slate-800">
                    {(selected.usedQuota / 1000).toFixed(0)}k m3
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-xl border border-emerald-100 bg-emerald-50/40 px-3 py-3">
                <p className="text-[9px] font-mono text-emerald-700 uppercase mb-1">
                  Rekomendasi Sistem
                </p>
      ...
      <Card padding={false}>
        <SectionHeader
          title="Ringkasan Kuota Perusahaan"
          icon={<Building2 size={13} />}
          accent="#059669"
        />
