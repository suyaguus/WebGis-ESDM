...
export const MOCK_SENSORS: Sensor[] = [
  ...
  },
  {
    ...
    lng: 105.261,
    status: "alert",
    staticWaterLevel: -42.5,
    waterLevelTrend: "falling",
    companyId: "c1",
    lastUpdate: "08:20 WIB",
  },
  // c2 — PT Bumi Raya (Metro)
  {
    ...
    lng: 105.307,
    status: "online",
    staticWaterLevel: -30.1,
    waterLevelTrend: "stable",
    companyId: "c2",
    lastUpdate: "08:05 WIB",
  },
  {
    id: "s4",
    code: "GN-018",
    type: "gnss",
    location: "Metro Pusat",
    lat: -5.125,
    lng: 105.319,
    status: "online",
  ...
  // c4 — PT Sumber Air (Tanggamus)
  {
    ...
    lng: 104.638,
    status: "maintenance",
    staticWaterLevel: -26.8,
    waterLevelTrend: "falling",
    companyId: "c4",
    lastUpdate: "07:30 WIB",
  },
  {
    id: "s8",
    code: "GN-045",
    type: "gnss",
    location: "Talang Padang",
    lat: -5.393,
    lng: 104.871,
    status: "online",
    staticWaterLevel: -25.5,
    waterLevelTrend: "stable",
    companyId: "c4",
    lastUpdate: "08:10 WIB",
  },
  // c5 — PT Karya Makmur (Kotabumi)
  {
    ...
    code: "SW-031",
    type: "water",
    location: "Kotabumi Kota",
    lat: -4.826,
    lng: 104.905,
    status: "alert",
    staticWaterLevel: -35.0,
    waterLevelTrend: "falling",
    companyId: "c5",
    lastUpdate: "08:18 WIB",
  },
  {
    id: "s10",
    code: "GN-067",
    type: "gnss",
    location: "Bukit Kemuning",
    lat: -4.692,
    lng: 104.837,
    status: "online",
    staticWaterLevel: -32.5,
    waterLevelTrend: "stable",
    companyId: "c5",
...
export const MOCK_ALERTS: Alert[] = [
  ...
  },
  {
    id: "a2",
    severity: "critical",
    title: "Sensor offline > 2 jam",
    description: "Sensor SW-019 tidak mengirim data · PT Bumi Raya",
    sensorCode: "SW-019",
  ...
  },
  {
    ...
    description: "SW-031 turun 3.2m dari baseline · PT Sumber Air",
    sensorCode: "SW-031",
  ...
  },
  {
    id: "a4",
    severity: "warning",
    title: "Batas pengambilan air mendekati kuota",
    description: "PT Tirta Mandiri mencapai 87% dari kuota tahunan",
  ...
  },
  {
    id: "a5",
    severity: "info",
    title: "Kalibrasi sensor terjadwal",
    description: "12 sensor akan dikalibrasi besok pukul 07:00 WIB",
    timestamp: "06:00 WIB",
    isRead: true,
  },
  {
    id: "a6",
    severity: "info",
    title: "User baru menunggu verifikasi",
    description: "3 akun baru dari PT Karya Makmur menunggu approval",
  ...
  },
  {
    id: "a7",
    severity: "warning",
    title: "Anomali data GNSS terdeteksi",
    description: "Spike nilai mendadak pada GN-067 · perlu investigasi",
    sensorCode: "GN-067",
    timestamp: "04:20 WIB",
    isRead: true,
  },
...
export const MOCK_USERS: User[] = [
  ...
  },
  {
    id: "u3",
    name: "Citra Dewi",
    email: "citra.d@bumiraya.co.id",
    role: "admin_perusahaan",
    company: "PT Bumi Raya",
    status: "active",
    lastLogin: "06:30 WIB",
  ...
  },
  {
    id: "u4",
    name: "Deni Kurniawan",
    email: "deni.k@dinas.go.id",
    role: "kepala_instansi",
    company: "Dinas ESDM DKI",
    status: "active",
    lastLogin: "Kemarin",
  ...
  },
  {
    ...
    email: "fitri.h@tirtamandiri.co.id",
    role: "admin_perusahaan",
  ...
  },
  {
    ...
    email: "gilang.r@sumberair.co.id",
    role: "surveyor",
    company: "PT Sumber Air",
    status: "active",
    lastLogin: "07:40 WIB",
  ...
  },
  {
    id: "u8",
    name: "Hana Wijaya",
    email: "hana.w@karyamakmur.co.id",
    role: "surveyor",
    company: "PT Karya Makmur",
    status: "pending",
    lastLogin: "-",
  ...
  },
  {
    id: "u9",
    name: "Indra Setiawan",
    email: "indra.s@karyamakmur.co.id",
    role: "surveyor",
    company: "PT Karya Makmur",
    status: "pending",
    lastLogin: "-",
...
export const MOCK_AUDIT_LOGS: AuditLog[] = [
  ...
  },
  {
    ...
    target: "Laporan Q1 2026",
    ip: "202.55.31.88",
    timestamp: "07:58:11 WIB",
    severity: "info",
  },
  {
    id: "al4",
  ...
  },
  {
    ...
    target: "Izin #IZN-2026-014",
    ip: "36.85.10.77",
    timestamp: "06:40:00 WIB",
    severity: "info",
  },
  {
    id: "al11",
    ...
    target: "PT Maju Jaya Tbk",
    ip: "202.55.31.88",
    timestamp: "06:22:34 WIB",
    severity: "info",
  },
  {
    id: "al12",
...
export const COMPANY_SENSORS: (typeof MOCK_SENSORS)[0][] = [
  ...
  },
  {
    ...
    lng: 105.289,
    status: "online",
    staticWaterLevel: -25.0,
    waterLevelTrend: "stable",
    companyId: "c1",
    lastUpdate: "07:58 WIB",
  },
  {
    id: "s13",
    code: "GN-031",
  ...
  },
  {
    ...
    lng: 105.289,
    status: "online",
    staticWaterLevel: -31.6,
    waterLevelTrend: "falling",
    companyId: "c1",
    lastUpdate: "07:50 WIB",
  },
  {
    id: "s15",
    code: "GN-044",
...
export const COMPANY_MEASUREMENTS: Measurement[] = [
  ...
  },
  {
    ...
    status: "verified",
    verifiedAt: "08:45 WIB",
    location: "Penjaringan",
  },
  {
    id: "m3",
    sensorCode: "SW-014",
    ...
    fotoCount: 4,
    submittedAt: "08:05 WIB",
    status: "verified",
    verifiedAt: "08:30 WIB",
    location: "Kamal Muara",
  },
  {
    id: "m4",
    sensorCode: "SW-021",
  ...
  },
  {
    ...
    catatan: "OK",
    fotoCount: 4,
    submittedAt: "07:50 WIB",
    status: "verified",
    verifiedAt: "08:20 WIB",
    location: "Pademangan",
  },
  {
    id: "m6",
...
export const SURVEYOR_TASKS: SurveyorTask[] = [
  {
    ...
    status: "measuring",
    assignedSensors: ["SW-007", "SW-021", "GN-055"],
    completedToday: 2,
    totalToday: 3,
    lastActivity: "08:14 WIB",
    location: "Cengkareng",
  },
  {
    id: "st2",
    ...
    status: "online",
    assignedSensors: ["GN-022", "SW-033"],
    completedToday: 2,
    totalToday: 2,
    lastActivity: "08:20 WIB",
    location: "Penjaringan",
  },
  {
    id: "st3",
    ...
    status: "online",
    assignedSensors: ["SW-014", "SW-048"],
    completedToday: 2,
    totalToday: 2,
    lastActivity: "08:10 WIB",
    location: "Kamal Muara",
  },
  {
    id: "st4",
    surveyorId: "u13",
    surveyorName: "Dian Permata",
    surveyorAvatar: "DP",
    phone: "0821-2345-6789",
    status: "offline",
    assignedSensors: ["GN-031", "GN-044", "SW-062"],
    completedToday: 0,
    totalToday: 3,
...
export const COMPANY_ACTIVITY: ActivityItem[] = [
  ...
  },
  {
    id: "ac2",
    type: "measurement",
    title: "Data pengukuran masuk",
    desc: "Eka Prasetya submit data SW-007 — menunggu verifikasi",
    time: "08:14 WIB",
    actor: "Eka Prasetya",
  },
  {
    ...
    desc: "GN-022 oleh Rudi Hermawan — diverifikasi",
    time: "08:45 WIB",
    actor: "Budi Santoso",
  },
  {
    id: "ac4",
    type: "sensor",
    title: "Sensor masuk maintenance",
    desc: "GN-044 di Sunter dijadwalkan kalibrasi rutin",
    time: "07:30 WIB",
    actor: "Sistem",
  },
  {
    ...
    type: "measurement",
    title: "Data pengukuran masuk",
    desc: "Sinta Wulandari submit data SW-014 — diverifikasi",
    time: "08:05 WIB",
    actor: "Sinta Wulandari",
  },
  {
    id: "ac6",
    type: "report",
  ...
  },
  {
    ...
    type: "measurement",
    title: "Data ditolak",
    desc: "SW-048 data dari Sinta Wulandari — foto tidak lengkap",
    time: "08:10 WIB",
    actor: "Budi Santoso",
  },
];
...
export const KADIS_STATS = [
  {
    ...
    value: "18",
    sub: "5 kab/kota Lampung",
    color: "green",
  },
  {
    label: "Total Sensor Aktif",
    value: "247",
    sub: "238 online · 9 masalah",
    color: "cyan",
  },
  {
...
export const KADIS_RECENT_REPORTS = [
  {
    id: "kr1",
    name: "Laporan Kepatuhan Provinsi Q1 2026",
    type: "Kepatuhan",
    date: "15 Apr 2026",
    size: "3.8 MB",
    format: "PDF",
  ...
  {
    id: "kr2",
    name: "Rekapitulasi Kuota Tahunan 2025",
    type: "Kuota",
    date: "02 Jan 2026",
    size: "2.1 MB",
    format: "XLSX",
  ...
  {
    id: "kr4",
    name: "Ringkasan Pengawasan Feb 2026",
    type: "Pengawasan",
    date: "28 Feb 2026",
    size: "1.6 MB",
    format: "PDF",
  ...
  {
    id: "kr5",
    name: "Ekspor Data Seluruh Perusahaan Apr 2026",
    type: "Custom",
    date: "17 Apr 2026",
    size: "-",
    format: "CSV",
