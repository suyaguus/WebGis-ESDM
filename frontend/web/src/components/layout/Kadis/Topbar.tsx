...
export default function Topbar() {
  ...
  return (
    <header className="h-[60px] bg-white border-b border-slate-100 flex items-center px-5 gap-4 flex-shrink-0 shadow-sm relative z-20 min-w-0">
      ...
      {/* Kepala Dinas badge */}
      <div className="hidden md:flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-50 border border-emerald-200 ml-1">
          ...
          {showAlerts && (
            <div className="absolute right-0 top-10 w-72 bg-white border border-slate-100 rounded-xl shadow-xl z-50 overflow-hidden animate-slide-up">
              <div className="px-4 py-2.5 border-b border-slate-100 flex items-center justify-between">
                <span className="text-[12px] font-semibold text-slate-700">Notifikasi Provinsi</span>
              ...
              <div className="px-4 py-2 border-t border-slate-100 bg-slate-50/50">
                <button onClick={() => setAlerts(false)} className="text-[11px] text-emerald-600 hover:text-emerald-700 font-medium w-full text-center">
