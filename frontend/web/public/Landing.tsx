...
export default function LandingPage({
  ...
  const waterSensors = MOCK_SENSORS.filter(
    (sensor) => sensor.type === "water",
  ).length;
  const gnssSensors = MOCK_SENSORS.filter(
    (sensor) => sensor.type === "gnss",
  ).length;
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-slate-100 animate-fade-in">
      ...
      >
        <div
          className="flex flex-col gap-2 sm:gap-2.5 w-fit"
        ...
        >
          ...
          <div
            ...
            style={{
              transition:
                "padding 300ms ease-out, border-radius 300ms ease-out",
            }}
          >
